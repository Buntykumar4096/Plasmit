                        ...
                        return (
                          <div key={item.id}>
                            <button
                              ...
                              onClick={() => {
                                if (item.id === "notes" || item.id === "diagnostic-hub") {
                                  ...
                                  return (
                                    <Link
                                      className={cn(
                                        ...
                                        childIsActive && "bg-sidebar-active text-sidebar-active-foreground hover:bg-sidebar-active hover:text-sidebar-active-foreground",
                                      )}
                                      href={child.route}
                                      key={child.id}
