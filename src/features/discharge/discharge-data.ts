...
export const mockDischargeChecklist: DischargeChecklistItem[] = [
  ...
  { id: "dc-c-005", planId: "disc-plan-001", category: "Nursing", label: "LDA/LDT and devices checked", source: "Nursing flowsheet", ownerRole: "Nurse", status: "Done", updatedBy: "Bedside Nurse", updatedAt: "Today 10:12" },
  { id: "dc-c-006", planId: "disc-plan-001", category: "Nursing", label: "Patient education and guardian counselling", source: "Education note", ownerRole: "Nurse", status: "Pending", updatedBy: "Bedside Nurse", updatedAt: "Today 10:15" },
