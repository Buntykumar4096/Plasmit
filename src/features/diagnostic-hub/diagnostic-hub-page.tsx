...
const categories = [
  { label: "All Reports", route: "/diagnostic-hub/overview", key: "all" },
                  ...
                  <div className="space-y-2 p-3" key={report.id}>
                    ...
                    <div className="flex justify-end gap-1">
                      <Button aria-label="View report" asChild size="icon" variant="ghost">
                        <Link href={report.category === "Imaging" ? "/diagnostic-hub/imaging-report-view" : "/diagnostic-hub/report-details"}><Eye className="h-4 w-4" /></Link>
                      </Button>
