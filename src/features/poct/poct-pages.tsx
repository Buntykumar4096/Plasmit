...
export function AddPoctPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Add POCT" actions={<ActionButtons />} />
      ...
      <div className="sticky bottom-0 z-20 -mx-4 border-t border-border bg-background px-4 py-3 shadow-[0_-6px_18px_rgba(39,37,54,0.06)] md:-mx-6 md:px-6">
...
export function ViewPoctResultPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="View POCT Result" actions={<ActionButtons />} />
      <Card>
