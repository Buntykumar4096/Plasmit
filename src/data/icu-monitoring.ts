...
export const cvsMetrics: CvsMetric[] = [
  { id: "heart-rate", label: "Heart Rate", shortLabel: "HR", value: "86", unit: "bpm", updatedAt: "2 min ago", status: "Stable", icon: HeartPulse, color: "#5B6EFF", sparkline: [82, 84, 83, 86, 85, 87, 86] },
  ...
  { id: "bp-arterial", label: "BP Arterial Line", shortLabel: "Art BP", value: "118/76", unit: "mmHg", detail: "MAP 90", updatedAt: "1 min ago", status: "Stable", icon: Waves, color: "#5B6EFF", sparkline: [89, 90, 91, 90, 90, 91, 90] },
...
export const trendOptions = [
  { id: "hr", label: "HR", key: "hr", unit: "bpm", color: "#5B6EFF" },
  ...
  { id: "bp-arterial", label: "BP Arterial", key: "arterialMap", unit: "MAP", color: "#5B6EFF" },
...
export const abdominalMetrics: AbdominalMetric[] = [
  { id: "iap", label: "Intra-abdominal Pressure", value: "14", unit: "mmHg", updatedAt: "8 min ago", status: "Stable", icon: Gauge, color: "#5B6EFF", sparkline: [13, 14, 14, 13, 14, 15, 14] },
  ...
  { id: "abdominal-drains", label: "Abdominal Drains Output", value: "640", unit: "ml / 24 hrs", updatedAt: "18 min ago", status: "Watch", icon: Activity, color: "#5B6EFF", sparkline: [24, 26, 28, 31, 32, 35, 36] },
];
...
export const abdominalChartConfigs = [
  { id: "iap", label: "IAP trend", latest: "14 mmHg", total: "Mean 14", dataKey: "iap", unit: "mmHg", color: "#5B6EFF" },
  ...
  { id: "abdominal-drains", label: "Abdominal Drains Output trend", latest: "36 ml/hr", total: "640 ml / 24 hrs", dataKey: "abdominalDrains", unit: "ml/hr", color: "#5B6EFF" },
] as const;
